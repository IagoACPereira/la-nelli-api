...
categoriasProdutosRouter
  ...
  .get('/categorias-produtos/', autenticacao, permissao(['admin', 'leitura', 'manipulacao']), CategoriasProdutosController.exibirTodos)
  .get('/categorias-produtos/:id', autenticacao, permissao(['admin', 'leitura', 'manipulacao']), CategoriasProdutosController.exibirUm)
  .put('/categorias-produtos/:id', autenticacao, permissao(['admin', 'manipulacao']), [
    body('categoria').notEmpty().withMessage('Campo Categoria é obrigatório'),
