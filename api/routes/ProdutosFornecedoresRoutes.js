...
produtosForncedoresRouter
  ...
  .get('/produtos-fornecedores/', autenticacao, permissao(['admin', 'leitura', 'manipulacao']), ProdutosFornecedoresController.exibirTodos)
  .get('/produtos-fornecedores/:id', autenticacao, permissao(['admin', 'leitura', 'manipulacao']), ProdutosFornecedoresController.exibirUm)
  .put('/produtos-fornecedores/:id', autenticacao, permissao(['admin', 'manipulacao']), [
    body('idFornecedor').notEmpty().withMessage('Campo Fornecedor é obrigatório'),
    body('idFornecedor').isNumeric().withMessage('Campo Fornecedor deve ser numérico'),
    body('idProduto').notEmpty().withMessage('Campo Produto é obrigatório'),
    body('idProduto').isNumeric().withMessage('Campo Produto deve ser numérico'),
