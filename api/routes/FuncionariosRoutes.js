...
funcionariosRouter
  ...
  .get('/funcionarios/', autenticacao, permissao(['admin']), permissao(['admin']), FuncionariosController.exibirTodos)
  .get('/funcionarios/:id', autenticacao, permissao(['admin']), FuncionariosController.exibirUm)
